...
export class AnthropicProvider extends LLMProvider {
    ...
    async analyzeImage(imageData, prompt = "Explain what this image is about") {
        ...
        try {
            ...
            console.log(`Analyzing image with media type: ${mediaType}, base64 length: ${imageData.base64.length}`);
            ...
            if (error.message.includes('rate limit')) {
                ...
                throw new Error('Failed to communicate with Anthropic API. Please check your connection.');
            } else if (error.message.includes('No content in API response')) {
                throw new Error('Received empty response from Anthropic API. Please try again.');
            } else {
                // For debugging purposes, include the original error message
