...
export class GeminiProvider extends LLMProvider {
    ...
    async processMemo(content, options = {}) {
        ...
        Process this web content into a memo:
        URL: ${url || 'Unknown'}
    ...
    async analyzeImage(imageData, prompt = "Explain what this image is about") {
        ...
        try {
            ...
            console.log(`Analyzing image with Gemini - media type: ${mediaType}, base64 length: ${imageData.base64.length}`);
            ...
            const response = await fetch(`${this.baseUrl}/models/${this.model}:generateContent?key=${this.apiKey}`, {
                ...
                body: JSON.stringify({
                    contents: contents,
                    generationConfig: this.getGenerationConfig({ maxTokens: 1024 }),
            ...
            if (error.message.includes('rate limit') || error.message.includes('quota')) {
                ...
                throw new Error('Image content blocked by safety filters. Please try a different image.');
                ...
                throw new Error('Failed to communicate with Gemini API. Please check your connection.');
            } else {
