...
export class AnthropicProvider extends LLMProvider {
    ...
    async analyzeImage(imageData, prompt) {
        try {
            ...
            console.log('Analyzing image - input data type:', typeof imageData);
            console.log('Image data preview:', imageData?.src || (typeof imageData === 'string' ? imageData.substring(0, 50) + '...' : 'Object'));
            ...
            if (typeof imageData === 'string' && imageData.startsWith('data:')) {
                ...
                console.log('Extracted from data URL - media type:', mediaType);
            } else if (typeof imageData === 'object' && imageData.src) {
                console.log('Fetching image from URL:', imageData.src);
                ...
                // Set media type from blob
                mediaType = blob.type || 'image/jpeg';
                console.log('Fetched image - media type:', mediaType, 'size:', blob.size);
                ...
                throw new Error('Invalid image data format. Expected data URL string or object with src property.');
            }
            ...
            if (!mediaType.startsWith('image/')) {
                throw new Error(`Invalid media type: ${mediaType}. Expected image/* format.`);
            }

            console.log('Sending image to Anthropic - media type:', mediaType, 'base64 length:', imageBase64.length);
            ...
            console.log('Successfully analyzed image with Anthropic');
            return {
